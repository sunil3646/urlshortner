...
// Configuration
const API_BASE_URL = (
  import.meta.env.VITE_API_BASE_URL || "https://urlshortner-e1n4.onrender.com"
).replace(/\/+$/, "");
        ...
        <nav>
          <button
            ...
            className={`px-3 py-1 rounded ${
              view === "dashboard" ? "bg-indigo-800" : "hover:bg-indigo-500"
            }`}
          >
            Dashboard
          </button>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {links.map((link) => (
                  <tr
                    ...
                    onClick={() => navigateToStats(link.code)}
                  >
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="pt-4 border-t flex justify-between text-xs text-gray-400">
              <span>
                Created: {new Date(statsData.createdAt).toLocaleDateString()}
              </span>
